...
According to Meisner and Albrechtsen, the best K is determined by 1+ D
(the optimal number of principal components). So D would be equal to 5
(determined by the elbow (broken-stick) method), so K=6.
